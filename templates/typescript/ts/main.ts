...
$({
    ...
    template:()=>view(
        ...
        //            ),
        //        ),
               btn({route:"/Home",is:'link',class:'ml12'},'Home' ),
               btn({route:"/PageOne",is:'link',class:'ml12'},'Grid' ),
               btn({route:"/PageTwo",is:'link',class:'ml12'},'GetData' ),
               btn({route:"/PageThree",is:'link',class:'ml12'},'Counter' ),
               btn({route:"/PageFour/123/222",is:'link',class:'ml12'},'Dynamic' ),
           ),
           br(3),
           view({id:"router"}),
    //    bottomNavigationBar(
    ...
    //        bottomNavigationBarItem(icon('person'),'Person'),
    //        bottomNavigationBarItem(icon('phone'),'Phone')
    //    ),
    //    br(3)
   ),
    include:[
